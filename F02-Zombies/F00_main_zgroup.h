#ifndef F00_MAIN_ZGROUP_H
#define F00_MAIN_ZGROUP_H
#include "../Sources/outools.h"
#include "../Sources/struct.h"
#include "F01_add_zgroup.h"
#include "F02_consult_zgroup.h"
#include "F03_manageZombies_zgroup/F03_manageZombies_zgroup.h"
#include "F04_delete_zgroup.h"
#include "F05_showFallen_zombies.h"
#include "F06_showLiving_zombies.h"
#include "FSS_extra.h"
...
void Menu_Zgroups(Zgroup **zgroup_list, squad **squad_list, bpck **backpack_list, soldier **fallen_soldier_list, zombie **fallen_zombie_list, vector<zombie *> type_Zombies)
{
    ...
    while (op)
    {
        ...
        coutf(BLUE, "1. Crear un nuevo grupo\n");
        coutf(BLUE, "2. Consultar grupos\n");
        coutf(BLUE, "3. Gestionar los integrantes (zombies) de un grupos\n");
        coutf(BLUE, "4. Eliminar un grupos\n");
        coutf(BLUE, "5. Mostrar todos los zombies caidos (muertos)\n");
        coutf(BLUE, "6. Mostrar todos los zombies vivos por cada grupos\n\n");
